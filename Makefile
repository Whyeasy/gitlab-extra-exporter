build:
	go build -o bin/gitlab-extra-exporter ./cmd/gitlab-extra-exporter
...
untag:
	...
	curl --request DELETE --header "Authorization: token ${GITHUB_TOKEN}" "https://api.github.com/repos/whyeasy/gitlab-extra-exporter/releases/:release_id/$(TAG)"
